...
def generate_scene() -> None:
    ...
    lines = [
        "# Generated by tools/generate_island.py. Do not edit by hand.",
        "# model <id> <asset-path>",
        "# spawn_model <id> px py pz sx sy sz colliderHalfX colliderHalfY colliderHalfZ",
        "",
    ...
    for _ in range(62):
        ...
        spawn(lines, model, x, z, scale, (0.6, 2.5, 0.6))
    ...
    for _ in range(34):
        ...
        spawn(lines, "rock", x, z, scale, (1.3, 0.9, 1.1))
